                        ...
                        <div class="swiper-slide" style="box-shadow: 5px 5px 5px 5px gray;margin-top:20px; border-radius:10px;" v-for="item in info" :key="item.index">
                            <div class="pos-relative">
                                ...
                                <div class="plr-25 ptb-15" style="background-color:white;">
                                    <h5 class="color-ash"><b v-text="item.time"></b></h5>
                                    <h4 class="mtb-10 color-black">
                                        <a :href="item.url" target="_blank"><b class="color-black light-color" v-text="item.title"></b></a></h4>
...
export default {
    ...
    mounted() {
        ...
        // this.getInfo();
        // alert(this.info[0].img_url);
        this.info = JSON.parse(this.$store.state.iinfo);
